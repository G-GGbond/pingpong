...
bool MqttProtocol::StartMqttClient(bool report_error) {
    ...
    auto endpoint = (std::string)"u2661166.ala.cn-hangzhou.emqxsl.cn";
    auto client_id = settings.GetString("uuid");
    auto username = "pingpong";
    auto password = "pingpong";
